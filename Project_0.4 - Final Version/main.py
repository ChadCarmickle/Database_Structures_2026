...
from tables.sale import sales_menu
...
REPORTS = [
    ("Display Sales Report      (Joins tables: SalesTransaction + TransactionItem + Products + Customers.)", sales_detail_report),
    ("Inventory Report          (Joins Inventory + Products + Supplier)", inventory_supplier_report),
]
